...
def check_workspace_build() -> bool:
    ...
    workspace_path = "/home/vanszs/Documents/ros2/ros2_ws"
    ...
    try:
        ...
        result = subprocess.run(['ros2', 'pkg', 'list'], 
                              capture_output=True, text=True, timeout=10)
        if 'drone_mvp' in result.stdout:
            success("drone_mvp package found")
            return True
        else:
            error("drone_mvp package not found")
            error("Run: just build-workspace")
            return False
    except Exception as e:
...
def check_mission_files() -> bool:
    ...
    base_path = "/home/vanszs/Documents/ros2/ros2_ws/src/drone_mvp"
