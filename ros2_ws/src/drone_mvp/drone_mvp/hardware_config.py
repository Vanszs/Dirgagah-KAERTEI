...
class HardwareConfig:
    ...
    def _load_defaults(self):
        ...
        self.config.set('flight_controller', 'connection_port', '/dev/ttyUSB0')
        self.config.set('flight_controller', 'baud_rate', '57600')
        
        self.config.add_section('cameras')
        self.config.set('cameras', 'front_camera_index', '0')
        self.config.set('cameras', 'back_camera_index', '2')
        self.config.set('cameras', 'top_camera_index', '4')
        
        self.config.add_section('gpio_pins')
        self.config.set('gpio_pins', 'front_magnet_pin', '18')
        self.config.set('gpio_pins', 'back_magnet_pin', '19')
